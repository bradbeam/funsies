...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/funsies/flexsearch.min.js');loadScript('/funsies/en.search-data.min.276bd5b475331f92ace3ca3cf7f31bbeb4da729bcaff52e8a6213e20c701c2e5.js',function(){input.required=false;search();});}
