...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/funsies/flexsearch.min.js');loadScript('/funsies/en.search-data.min.f8651acdb063c064b2aa34285ba67d78c3fac9134a916ec02a7153ca4417b8da.js',function(){input.required=false;search();});}
